...
const Root = styled.div<SkeletonProps>`
  ...
  border-radius: ${({ variant, theme }) => (variant === VARIANT.CIRCLE ? '50%' : theme.radius.small)};
...
const Waves = styled(Root)`
  ...
  &:before {
    content: '';
    position: absolute;
    background-image: linear-gradient(90deg, transparent, rgba(243, 243, 243, 0.3), transparent);
    top: 0;
    left: -150px;
    height: 100%;
    width: 150px;
