...
export interface Multicall extends BaseContract {
  ...
  estimateGas: {
    aggregate(calls: Multicall2.CallStruct[], overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    aggregate(calls: Multicall2.CallStruct[], overrides?: CallOverrides): Promise<PopulatedTransaction>;
