...
import type { AccessControlledAggregator, AccessControlledAggregatorInterface } from '../AccessControlledAggregator';
...
export class AccessControlledAggregator__factory {
  static readonly abi = _abi;
  static createInterface(): AccessControlledAggregatorInterface {
    return new utils.Interface(_abi) as AccessControlledAggregatorInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): AccessControlledAggregator {
    return new Contract(address, _abi, signerOrProvider) as AccessControlledAggregator;
  }
}
