...
import { StyledTooltip, Arrow } from './styles';
...
const useTooltip = (content: React.ReactNode, options: TooltipOptions): TooltipRefs => {
  ...
  const tooltip = (
    <StyledTooltip
      ...
      {...attributes.popper}
    >
      <ThemeProvider theme={RoboTheme}>{content}</ThemeProvider>
      <Arrow background={background} ref={setArrowElement} style={styles.arrow} />
    </StyledTooltip>
  );
