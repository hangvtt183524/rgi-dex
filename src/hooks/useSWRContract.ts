...
import { FetchStatus } from 'config/constants/status';
import { ContractMethodName, ContractMethodParams, MaybeContract } from 'config/types/contracts';
import { Call, MulticallOptions } from 'packages/multicall';
